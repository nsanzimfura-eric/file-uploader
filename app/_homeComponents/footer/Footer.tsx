...
const Footer = (props: FooterProps) => {
    const { } = props;
    return (
        <footer className="bg-primary w-full rounded-lg shadow dark:bg-gray-900 m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="https://nsanzimfura.web.com/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
