...
const Form = () => {
    ...
    return (
        <form action={saveFile} className='bg-none flex flex-col items-center gap-1'>
            <div className="bg-none flex items-center gap-6">
                <input
                    type="file"
                    id="file"
                    name="file"
                ...
                <div
                    ...
                    className="flex cursor-pointer gap-1 bg-card-foreground h-[60px] sm:h-[40px] min-w-[300px] text-white border-none rounded-[5px] items-center p-[10px] transition-all hover:bg-primary"
                >
                    <Image
                        src="/logo.svg"
                        width={25}
                ...
                <button type="submit" className="bg-success rounded-[5px] text-white bg-primary h-[60px] sm:h-[40px] flex items-center justify-center p-[0px_20px] hover:bg-card-foreground transition-all">save</button>
            </div>
            {formik.errors &&
                <div className="m-0 p-0">
                    {formik.errors.file &&
                        <FeedbackNotification title="error" message={formik.errors.file} />
                    }
                    {formik.errors.fileName &&
                        <FeedbackNotification title="error" message={formik.errors.fileName} />
                    }
                </div>}
        </form>
    );
